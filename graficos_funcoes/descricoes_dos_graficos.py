...
DESCRICAO_MAPA_GINI = Div(text="""
                                    ...
                                    menor IDH, possui um dos maiores níveis de Gini, rivalizando na questão de desigualdade social com Brasil que<br>
                                    possui o segundo maior coeficiente de Gini no mundo.  
                                    """)
